        ...
        <div className="w-full h-full flex-col flex gap-y-2 tracking-wide mt-2">
            {
                searchResults && searchResults.searchResults.map((result, index) => {
                    ...
                    return (
                        <div key={index} className="px-2 py-2 rounded-md flex  group hover:scale-102 transition-all cursor-pointer shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
